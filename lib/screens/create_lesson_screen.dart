...
class _CreateLessonScreenState extends State<CreateLessonScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final cards = _cards
          ...
          .map((c) =>
              LessonCard(front: c.front.text.trim(), back: c.back.text.trim()))
          .toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(isEdit ? 'Edit lesson' : 'New lesson')),
      body: Form(
        key: _formKey,
        child: ListView(
          ...
          children: [
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            hintText: 'Point ${i + 1}', isDense: true),
                      ),
                    ),
                    IconButton(
            ...
            _addButton(
                'Add card', () => setState(() => _cards.add(_CardCtrl()))),
